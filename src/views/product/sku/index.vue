    ...
    <el-card>
        <el-table style="margin: 10px 0px;" border :data="skuArr">
            ...
            <el-table-column label="操作" align="center" width="250px" fixed="right">
                <template #="{ row }">
                    <el-button :type="row.isSale == 1 ? 'warning' : 'success'" size="small" :icon="row.isSale == 1 ? 'Bottom' : 'Top'"
                        @click="updateSale(row)"></el-button>
                    <el-button type="primary" size="small" icon="Edit" @click="updateSku"></el-button>
                    <el-button type="info" size="small" icon="InfoFilled" @click="checkSku(row)"></el-button>
