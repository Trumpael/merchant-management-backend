<template>
    <el-form label-width="100px">
        ...
        <el-form-item label="图片名称">
            <el-table border highlight-current-row :data="imgArr" ref="table" @current-change="handleCurrentChange">
                ...
                <el-table-column label="操作">
                    <template #="{ row }">
                        <el-button :disabled="!isCurrentRow(row)" type="primary" size="small" @click="handler(row)">设置默认</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-form-item>
