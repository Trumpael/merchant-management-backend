<template>
    <el-button size="small" icon="Refresh" title="刷新" circle @click="updateRefsh"></el-button>
    <el-button size="small" icon="FullScreen" title="全屏" circle @click="fullScreen"></el-button>
...
const changeDark = () => {
    ...
    dark.value ? html.style.setProperty('background-color', '#000000') : html.style.setProperty('background-color', '#FFFFFF');
}
